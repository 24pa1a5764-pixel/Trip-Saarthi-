...
export const PHOTO_SPOTS: PhotoSpot[] = [
  ...
  { name: "Golden Temple Night", loc: "Amritsar", bestTime: "8:00 PM - 10:00 PM", type: "night", tip: "Reflection in the holy pool is magical — use tripod for long exposure", icon: "✨", img: "https://images.unsplash.com/photo-1514222288981-d703126abeb9?w=400&q=80", rating: 4.9 },
