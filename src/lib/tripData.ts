...
export const MOCK_DATA: Record<string, Place[]> = {
  heritage: [
    ...
    { name: "Golden Temple", loc: "Amritsar", img: "https://images.unsplash.com/photo-1514222288981-d703126abeb9?w=400&q=80", lat: 31.6200, lng: 74.8765, rating: 4.9, duration: "2-3 hrs", price: "Free", description: "Holiest Gurdwara and spiritual center of Sikhism" },
  ...
  shopping: [
    { name: "Dilli Haat", loc: "Delhi", img: "https://images.unsplash.com/photo-1587474260584-136574528ed5?w=400&q=80", lat: 28.5728, lng: 77.2086, rating: 4.2, duration: "2-3 hrs", price: "₹30 entry", description: "Open-air market with handicrafts from across India" },
